...
export const viewingProperty: ViewingProperty = {
  ...
  details: [
    ...
    { label: "契約期間", value: "最短1ヶ月から可（長期入居を優先する場合あり／冬期の退去はできるだけ避けてご相談）" },
  ...
  faq: [
    ...
    },
    {
      ...
      a: "最短1ヶ月からご入居いただけます。長く住んでいただける方を優先する場合はありますが、短期でも対応可能なので、まずはお気軽にお問い合わせください。なお、冬の期間（厳冬期）の退去はできるだけ避けていただけると助かります。",
    },
    {
