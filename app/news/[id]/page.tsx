...
const newsArticles: NewsArticle[] = [
  {
    ...
    content: `
      ...
      <h2>参加方法</h2>
      <p>参加をご希望の方は、以下のフォームからお申し込みください！定員に達し次第、申し込みを締め切らせていただきます。 お申し込みは<a href="/contact" style="color: #e67e22;">こちら</a>からお願いします。</p>
  ...
  },
  {
    ...
    content: `
      ...
      <h2>オープン記念</h2>
      <p>オープン記念として、4月15日から30日まで全商品20%OFFのセールを開催します。この機会にぜひぜひお立ち寄りください！！</p>

      <h2>店主からaaのメッセージ</h2>
      <blockquote style="background-color: #f8f9fa; padding: 20px; border-left: 4px solid #e67e22; margin: 20px 0;">
        「オンタリオ州全体の皆様に日本の伝統的な和菓子の美味しさと素晴らしさをお届けしたいと思い、この店をオープンしました！季節に応じた和菓子を通じて、日本の文化と味を体験していただければ幸いです。」
      </blockquote>

      <p>和菓子処 桜じまんで、日本の超伝統的な味と新しいアレンジを楽しんでください！</p>
    `,
    category: "オープン",
    image: "/images/img3.png",
    author: "商店街事務局",
    tags: ["お和菓子系", "オープン", "新店舗", "スイーツなど"],
  },
  {
    id: 4,
    date: "2023-02-28",
    ...
    content: `
      <p>ゴールデンウィーク期間中に、日本人商店街で様々なイベントを開催します。日本文化体験、特別セール、ライブパフォーマンスなど盛りだくさんです。</p>
      ...
      <ul>
        ...
        <li>14:00-16:00 初動ライブワークショップ</li>
        <li>18:00-20:00 和太鼓ライブパフォーマンスんす</li>
      </ul>

      <h3>4月30日（日）</h3>
      <ul>
        <li>11:00-7:00 着物着付け体験</li>
      ...
      <ul>
        ...
        <li>19:00-21:00 和服着付け大会</li>
      </ul>

      <h3>5月10日（水）</h3>
      <ul>
        <li>10:00-14:00 武道デモンストレーション</li>
        <li>14:00-16:00 日本文化クイズ大会</li>
        <li>18:00-20:00 閉会式・抽選会</li>
      </ul>

      <h2>特別セール情報</h2>
      <p>期間中、参加店舗で特別セールを実施いたします。ぜひお立ち寄りください！：</p>
      <ul>
        <li>食品店：全商品15%OFF</li>
        <li>雑貨店：全商品20%OFF</li>
      ...
      <h2>参加方法</h2>
      <p>各イベントへの参加に関しましては、当日受付または事前予約が必要です。詳細は各店舗にお問い合わせください。</p>
      ...
      <p>ゴールデンウィーク期間、日本人商店街で日本の文化と味を存分にお楽しみください！</p>
    `,
    category: "イベント",
  ...
  },
  {
    id: 5,
    date: "2022-12-24",
    title: "クリスマスイベント開催します！",
    content: `
      <p>クリスマスシーズンに合わせて、日本人商店街で特別なクリスマスイベントを開催します。日本のクリスマス文化とカナダのクリスマスを融合した楽しいイベントです。</p>
      
      <h2>イベント概要</h2>
      <p>日本のクリスマスといえば、ケーキとチキンが定番ですよね。今回のイベントでは、日本のクリスマス文化を紹介しながら、カナダのクリスマスも楽しめる特別な企画を用意しました。</p>
