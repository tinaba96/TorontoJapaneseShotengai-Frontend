...
const newsArticles: NewsArticle[] = [
  {
    ...
    content: `
      <p>トロントで起業を目指す日本人のためのオンラインイベントを開催いたします。このイベントでは、経験豊富な起業家による講演とネットワーキングの機会を提供します。ぜひご参加ください。</p>
      ...
      <h2>登壇者</h2>
      <p>今回のイベントでは、トロントで成功を収めている日本人起業家の方々をお招きします。実際の体験談を聞くことで、起業への道筋をより明確に理解できるでしょう。</p>

      <h2>参加方法</h2>
      <p>参加をご希望の方は、以下のフォームからお申し込みください。定員に達し次第、申し込みを締め切らせていただきます。</p>
  ...
  },
  {
    ...
    title: "日本食バトル開催決定",
    content: `
      <p>トロントの日本食レストランが参加する日本食バトルが開催されます。地元のシェフたちが腕を競い合い、最高の日本食を提供します。</p>
      
      <h2>イベント概要</h2>
      <p>今回の日本食バトルでは、トロント市内の有名日本食レストランが参加し、それぞれの店舗の看板メニューを披露します。来場者の投票により、最優秀賞が決定されます。</p>
  ...
  },
  {
    ...
    content: `
      ...
      <blockquote style="background-color: #f8f9fa; padding: 20px; border-left: 4px solid #e67e22; margin: 20px 0;">
        「トロントの皆様に日本の伝統的な和菓子の美味しさをお届けしたいと思い、この店をオープンしました。季節に応じた和菓子を通じて、日本の文化と味を体験していただければ幸いです。」
      </blockquote>
